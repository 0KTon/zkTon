...
export class NftAuctionLocal {
    ...
    async getSaleData() {
        ...
        return {
            ...
            marketplaceAddress: marketplaceAddressSlice.loadAddress()!,
            nftAddress: nftAddressSlice.loadAddress()!,
            nftOwnerAddress: nftOwnerAddressSlice.loadAddress(),
            lastBidAmount,
            lastBidAddress: lastBidAddressSlice.loadAddress(),
            minStep,
            marketplaceFeeAddress: marketplaceFeeAddressSlice.loadAddress()!,
            marketplaceFeeFactor, marketplaceFeeBase,
            royaltyAddress: royaltyAddressSlice.loadAddress()!,
            royaltyFactor, royaltyBase,
            maxBid,
            minBid,
